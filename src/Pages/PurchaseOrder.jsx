...
import { MailOutlined, PlusOutlined, PlusSquareOutlined, DollarCircleOutlined, InsertRowBelowOutlined, FileImageOutlined } from "@ant-design/icons";
...
const PurchaseOrder = () => {
    ...
    return (
        <>
            <div className=" w-[80%] mx-[10%] m-4 border  pt-16  p-10 rounded-lg shadow-2xl">
                <div className=" text-4xl text-center  mb-14">
                ...
                <div className=" flex flex-row justify-between mb-10">
                    <div className="w-[45%]">
                        <div className="flex flex-row p-1 mb-4 ">
                            <text className="text-xl flex flex-col border-b-2 w-[30%] mr-7"><text>Purchase</text> <text>Order No</text></text>
                            <input type="text" placeholder="A00001" name="" className="w-[70%] border-b-2 " />
                        </div>

                        <div className="flex flex-row p-1 mb-4 ">
                            <text className="text-xl flex flex-col border-b-2 w-[30%] mr-7"><text>Purchase</text> <text>Order Date</text></text>
                            <input type="date" placeholder="" name="" className="w-[70%] border-b-2 " />
                        </div>

                        <text><PlusSquareOutlined className="text-blue-600" /> Add More Fields</text>
                    </div>

                    <div className="w-[40%] bg-slate-200 flex flex-col justify-center items-center text-center p-4 rounded-md">
                ...
                <div className="flex flex-row justify-between w-[100%]">
                    <form action="" className="p-5 bg-blue-50 rounded-lg flex flex-col justify-between w-[47%]">
                        <h1 className="text-2xl m-2 ">Order By <text className="text-lg text-gray-500"> (Your Details)</text></h1>
                        <input type="text" name="" placeholder="inputfiled" className="m-2 p-3  border-b-2 bg-blue-50" />
                        <input type="text" name="" placeholder="inputfiled" className="m-2 p-3  border-b-2 bg-blue-50" />
                        <input type="text" name="" placeholder="inputfiled" className="m-2 p-3  border-b-2 bg-blue-50" />
                        <input type="text" name="" placeholder="inputfiled" className="m-2 p-3  border-b-2 bg-blue-50" />

                        <div className="ml-1 flex flex-row justify-between w-[100%] ">
                            <input type="text" name="" placeholder="inputfiled" className="m-2 p-3 w-[50%]  border-b-2 bg-blue-50" />
                            <input type="text" name="" placeholder="inputfiled" className="m-2 p-3 w-[50%]  border-b-2 bg-blue-50" />
                        </div>
                ...
                <div className="flex flex-row justify-between mt-7 mb-4 w-[100%]">
                    <div className=" mt-7 w-[30%]">
                        <input type="text" placeholder="input field" className="border  border-gray-300 p-2 rounded-md" />
                    </div>
                ...
                <table className="bg-blue-50 w-full mb-2 mt-10 ">
                    ...
                    <tr>
                        <td><input type="text" name="" placeholder="inputfiled" className="p-4 w-[50vh] ml-3 bg-blue-50 border-b-2 outline-none" /></td>
                        <td><input type="text" name="" placeholder="inputfiled" className="p-4 w-[25vh] bg-blue-50 border-b-2 outline-none" /></td>
                        <td><input type="text" name="" placeholder="inputfiled" className="p-4 w-[25vh] bg-blue-50 border-b-2 outline-none" /></td>
                        <td><input type="text" name="" placeholder="inputfiled" className="p-4 w-[25vh] bg-blue-50 border-b-2 outline-none" /></td>
                    </tr>
                    <tr>
                        <td className="p-4 w-[10vh]"><PlusSquareOutlined /> Add Description</td>
                    ...
                    <tr className="mb-4">
                        ...
                        <td><input type="text" name="" placeholder="inputfiled" className="p-4 bg-blue-50 border-b-2 outline-none" /></td>
                    </tr>
                </table>

                <h1 className="p-2 border-2 border-dotted items-center pl-[45%] mb-10"><PlusSquareOutlined className="text-blue-500" /> Add New Line</h1>

                <div className="flex flex-col mb-4 w-[40%] ml-[60%]">
