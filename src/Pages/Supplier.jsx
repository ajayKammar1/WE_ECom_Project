        ...
        <>
            <div className=" bg-white-400 h-full w-200 m-4 rounded-3xl border-black border-2 shadow-lg">
                ...
                <div className="flex flex-row bg-gray-200 rounded-b-3xl">
                    ...
                    <div className="w-full mt-3 ml-3 rounded-br-3xl bg-white rounded-md ">
                            ...
                            <div className="w-[1100px]">
                                <div className="flex flex-row justify-between p-2 mb-2">
                                    <div className="w-[500px] flex flex-row justify-between ">
                                        <label>Name*</label>
                                        <input type="text" placeholder="Name" value="" className="border w-64" />
                                    </div>

                                    <div className="w-[500px] flex flex-row justify-between ">
                                        <label>Internal Representative* </label>
                                        <input type="text" placeholder="Internal Representative*" value="" className="border w-64" />
                                    </div>
                                </div>
                                ...
                                <div className="flex flex-row justify-between p-2 mb-5">
                                    <div className="w-[500px] flex flex-row justify-between ">
                                        <label>Type*</label>
                                        <input type="text" placeholder="Type" value="" className="border w-64" />
                                    </div>

                                    <div className="w-[500px] flex flex-row justify-between ">
                                        <label>Relationship Since* </label>
                                        <input type="date" placeholder="" value="" className="border w-64" />
                                    </div>
                                </div>
                                ...
                                <div className="flex flex-row justify-between p-2 mb-5">
                                    ...
                                    <div className="w-[500px] flex flex-row justify-between ">
                                        ...
                                        <input type="text" placeholder="First Name" value="" className="border w-48 mr-2" />
                                        <input type="text" placeholder="Last Name" value="" className="border w-48" />
                                    </div>
                                </div>
                                ...
                                <div className="flex flex-row justify-between p-2 mb-5">
                                    ...
                                    <div className="w-[500px] flex flex-row justify-between ">
                                        ...
                                        <input type="email" placeholder="Internal Representative*" value="" className="border w-64" />
                                    </div>
                                </div>
                                ...
                                <div className="flex flex-row justify-between p-2 mb-5">
                                    ...
                                    <div className="w-[500px] flex flex-row justify-between ">
                                        ...
                                        <input type="email" placeholder="" value="" className="border w-64" />
                                    </div>
                                </div>
                                ...
                                <div className="flex flex-row justify-between p-2 mb-5">
                                    ...
                                    <div className="w-[500px] flex flex-row justify-between ">
                                        ...
                                        <input type="number" placeholder="Internal Representative*" value="" className="border w-64" />
                                    </div>
                                </div>
